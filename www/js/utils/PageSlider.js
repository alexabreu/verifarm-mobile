define(function (require) {
    ...
    return function PageSlider(container) {
        ...
        this.slidePage = function (page, menu) {
            ...
            if (currentPage.hasClass("page-offset")) {
                stateHistory.push(state);
                currentPage.remove();
                container.append(page);
                page.attr("class", "page page-offset");
        ...
        this.toggleMenu = function() {
            if (currentPage.hasClass("page-offset")) {
                currentPage.attr("class", "page page-center transition");
            } else {
                currentPage.attr("class", "page page-offset transition");
            }
        }
